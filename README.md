...
When the player wins tokens they have the option to wager their winnings in a double or nothing to add some interest to the game.

Lastly, if the player runs out of tokens they can use the clicker on the side to earn more coins to continue spinning. The player can also purchace an auto-miner to continually press the coin to earn more tokens.
